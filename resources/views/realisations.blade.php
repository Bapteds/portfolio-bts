    ...
    <div class=" w-[100%]  overflow-y-scroll flex justify-center ">
        <div class="h-[100%] w-[98%] flex flex-col items-center  space-y-8 pt-3 pb-3 ">
            ...
            <div class="w-[90%] h-96 bg-light-gray flex flex-row justify-around items-center rounded-md shadow-sm ">
                ...
                <div class="w-[46%] h-[90%] rounded-md flex items-center justify-center bg-light-black">
                    <div class="w-[93%] h-[85%] flex items-center justify-center flex-col space-y-3  ">
                        <a class="font-bold uppercase text-start w-[95%] text-button-vio text-3xl" href="{{route('realisations.image','nolark')}}" target="_blanck">Nolark</a>
            ...
            <div class="w-[90%] h-96 bg-light-gray flex flex-row justify-around items-center rounded-md shadow-sm ">
                <div class="w-[46%] h-[90%] rounded-md flex items-center justify-center bg-light-black">
                    <div class="w-[93%] h-[85%] flex items-center justify-center flex-col space-y-3  ">
                        <a class="font-bold uppercase text-start w-[95%] text-button-vio text-3xl" href="{{route('realisations.image','chocolatein')}}" target="_blanck">Chocolate'In</a>
                        <h1 class="text-white text-xl tracking-wide text-justify w-[95%] leading-relaxed">Site vitrine
                        ...
                        <div id="default-carousel" class="relative w-full h-[100%] bg-light-black rounded-md"
                            ...
                            <div class="relative h-[100%] overflow-hidden rounded-lg">
                                ...
                                <div class=" duration-700 ease-in-out flex items-center justify-center" data-carousel-item>
                                    <img src="{{  Vite::asset('resources/img/chocolatein/accueil.png') }}" class=" h-[100%]  "
                                        alt="...">
                                </div>
                                <!-- Item 2 -->
                                <div class="flex items-center justify-center duration-700 ease-in-out" data-carousel-item>
            ...
            <div class="w-[90%] h-96 bg-light-gray flex flex-row justify-around items-center rounded-md shadow-sm ">
                ...
                <div class="w-[46%] h-[90%] rounded-md flex items-center justify-center bg-light-black">
                    <div class="w-[93%] h-[85%] flex items-center justify-center flex-col space-y-3  ">
                        <a class="font-bold uppercase text-start w-[95%] text-button-vio text-3xl" href="{{route('realisations.image','gsb')}}" target="_blanck">Galaxy Swiss Bourdin
                        </a>
            ...
            <div class="w-[90%] h-96 bg-light-gray flex flex-row justify-around items-center rounded-md shadow-sm ">
                <div class="w-[46%] h-[90%] rounded-md flex items-center justify-center bg-light-black">
                    <div class="w-[93%] h-[85%] flex items-center justify-center flex-col space-y-3  ">
                        <a class="font-bold uppercase text-start w-[95%] text-button-vio text-3xl" href="{{route('realisations.image','mdl')}}" target="_blanck">Maison des ligues</a>
            ...
            <div class="w-[90%] h-96 bg-light-gray flex flex-row justify-around items-center rounded-md shadow-sm ">
                ...
                <div class="w-[46%] h-[90%] rounded-md flex items-center justify-center bg-light-black">
                    <div class="w-[93%] h-[85%] flex items-center justify-center flex-col space-y-3  ">
                        <a class="font-bold uppercase text-start w-[95%] text-button-vio text-3xl" href="{{route('realisations.image','capat')}}" target="_blanck">CAPAT
                        </a>
                        ...
                        <h2 class="text-gray-300 text-left w-[95%] pt-1"><span
                                class="text-button-vio uppercase font-bold text-lg">Téchnologies :</span> <br> Laravel, Blade,Html, TailWind, LiveWire, PGSQL, Grafana, JavaScript, Versionnage </h2>
                    </div>
                </div>
            </div>
            <div class="w-[90%] h-96 bg-light-gray flex flex-row justify-around items-center rounded-md shadow-sm ">
                <div class="w-[46%] h-[90%] rounded-md flex items-center justify-center bg-light-black">
                    <div class="w-[93%] h-[85%] flex items-center justify-center flex-col space-y-3  ">
                        <a class="font-bold uppercase text-start w-[95%] text-button-vio text-3xl" href="{{route('realisations.image','mycelium')}}" target="_blanck">Mycelium</a>
                        <h1 class="text-white text-xl tracking-wide text-justify w-[95%] leading-relaxed">Mycelium, est un ensemble de logiciel, permettant la centralisation, la transformation et la redistribution des données entre les services.
                            L'architecture s'appuie sur SystemD, Kafka, et Grafana.
                        </h1>
                        <h2 class="text-gray-300 text-left w-[95%] pt-1"><span
                                class="text-button-vio uppercase font-bold text-lg">Téchnologies :</span> <br> Linux, Grafana, Apache Kafka </h2>
                    </div>
                </div>
                <div class="w-[47%] h-[100%] flex justify-center items-center">
                    <div class="h-[90%] w-[99%]  flex items-center justify-center  rounded-md">
            ...
            <div class="w-[90%] h-96 bg-light-gray flex flex-row justify-around items-center rounded-md shadow-sm ">
                ...
                <div class="w-[46%] h-[90%] rounded-md flex items-center justify-center bg-light-black">
                    <div class="w-[93%] h-[85%] flex items-center justify-center flex-col space-y-3  ">
                        <a class="font-bold uppercase text-start w-[95%] text-button-vio text-3xl" href="{{route('realisations.image','vols')}}" target="_blanck">Gestion des vols
                        </a>
                        <h1 class="text-white text-xl tracking-wide text-justify w-[95%] leading-relaxed">Application de gestion des vols, s'appuyant sur l'architecture de Mycelium. Dans laquelle on retrouve des interfaces CRUD, pour la saisie des aéronefs, des pilotes, et des demandes de vol. 
                            L'application a pour but de montrer le fonctionnement de Mycelium, en utilisant des données provenant de plusieurs applications.
                        </h1>
                        </h1>
                        <h2 class="text-gray-300 text-left w-[95%] pt-1"><span
                                class="text-button-vio uppercase font-bold text-lg">Téchnologies :</span> <br> Laravel, Blade,Html, TailWind, LiveWire, PGSQL, Grafana, JavaScript, Kafka </h2>
                    </div>
                </div>
            </div>
